...
namespace WellaMates.Helpers
{
    public static class HtmlHelperExtensions
    {
        ...
        {
            return TableHeaderFor(htmlHelper, null, null, null, null, expression, null);
        }
        ...
        {
            return TableHeaderFor(htmlHelper, null, null, currentFilter, currentSort, expression, null);
        }
        ...
        {
            return TableHeaderFor(htmlHelper, null, actionName, currentFilter, currentSort, expression, null);
        }

        public static MvcHtmlString TableHeaderFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, string name, Expression<Func<TModel, TProperty>> expression)
        {
            return TableHeaderFor(htmlHelper, name, null, null, null, expression, null);
        }

        public static MvcHtmlString TableHeaderFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, string name, string actionName, string currentFilter, string currentSort, Expression<Func<TModel, TProperty>> expression)
        {
            return TableHeaderFor(htmlHelper, name, actionName, currentFilter, currentSort, expression, null);
        }

        public static MvcHtmlString TableHeaderFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, string name, string actionName, string currentFilter, string currentSort, Expression<Func<TModel, TProperty>> expression, object htmlAttributes)
        {
            if (expression == null)
            {
                throw new ArgumentNullException("expression");
            }
            return TableHeaderHelper<TModel, TProperty>(htmlHelper,
        ...
        private static MvcHtmlString TableHeaderHelper<TModel, TProperty>(HtmlHelper htmlHelper, ModelMetadata metadata, string name, string actionName, string currentFilter, string currentSort, Expression<Func<TModel, TProperty>> expression, IDictionary<string, object> htmlAttributes)
        {
            ...
            return MvcHtmlString.Create(HtmlHelper.GenerateLink(htmlHelper.ViewContext.RequestContext, htmlHelper.RouteCollection, name ?? metadata.DisplayName, null, actionName ?? htmlHelper.ViewContext.RouteData.Values["action"].ToString(), null, routeValues, htmlAttributes));
        }
